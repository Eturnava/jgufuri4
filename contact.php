...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['name'], $_POST['surname'], $_POST['email'], $_POST['message'])) {
    ...
    $confirmation = "Thank you for contacting us! Your message has been received.";
}

render_head("Contact Us");
      ...
      <div class="col-lg-6">
        <div class="right-content">
          <div class="row">
            ...
            <div class="col-lg-12">
              <?php if ($confirmation): ?>
                <div class="alert alert-success"><?= htmlspecialchars($confirmation) ?></div>
              <?php endif; ?>
